...
; 0000 003C // Mode: Phase correct PWM top=0xFF
; 0000 003D // OC0 output: Non-Inverted PWM
; 0000 003E // Timer Period: 0.06375 ms
; 0000 003F // Output Pulse(s):
; 0000 0040 // OC0 Period: 0.06375 ms Width: 6.5 us
; 0000 0041 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(97)
	OUT  0x33,R30
...
; 0000 0047 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(0)
	OUT  0x39,R30
; 0000 0048 
; 0000 0049 
