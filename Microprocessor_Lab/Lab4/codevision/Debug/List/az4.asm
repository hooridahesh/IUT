...
_0x20000:
	...
	.DB  0x30,0x32,0x64,0x0,0x46,0x55,0x4C,0x4C
	.DB  0x0,0x25,0x34,0x64,0x0,0x25,0x34,0x64
	.DB  0x4D,0x53,0x30,0x0,0x25,0x34,0x64,0x55
	.DB  0x53,0x30,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0001 0083     if(PINB.7 == 0 && emptyCapacity > 0){
	SBIC 0x16,7
	RJMP _0x20013
	LDS  R26,_emptyCapacity
	LDS  R27,_emptyCapacity+1
	CALL __CPW02
	BRLT _0x20014
_0x20013:
	RJMP _0x20012
...
; 0001 0084         emptyCapacity--; //car in
	LDI  R26,LOW(_emptyCapacity)
	LDI  R27,HIGH(_emptyCapacity)
	LD   R30,X+
	LD   R31,X+
	SBIW R30,1
	RJMP _0x2001D
...
_0x20016:
	LDS  R30,_emptyCapacity
	LDS  R31,_emptyCapacity+1
	SBIW R30,0
	BRNE _0x20019
; 0001 008C     {
